...
soft_taps = csv_to_taps(surfaces[0])
medium_taps = csv_to_taps(surfaces[1])
hard_taps = csv_to_taps(surfaces[2])

print (type (soft_taps[0]))

for tap in soft_taps:
    print (tap.surface == "hard")
    print(tap.surface)
    print (tap.seconds)
    print (tap.timeseries)

plt.plot (soft_taps[1].timeseries)
plt.show()
...
desk_taps_train = even_items(soft_taps)
desk_taps_test = odd_items(soft_taps)

bubble_taps_train = even_items(medium_taps)
bubble_taps_test = odd_items(medium_taps)

hand_taps_train = even_items(hard_taps)
hand_taps_test = odd_items(hard_taps)
